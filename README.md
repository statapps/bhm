...
1. First, you need to install the 'devtools' package. You can skip this step if you have 'remotes' inst
...
7. version 1.19 add penalized likelihood ratio text for glm "glmpLRT"
